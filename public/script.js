...
var Afficheur = function(element) {
    ...
    function setText(message) {
        affichage.innerHTML += "<span style='color: green;'>user@linux:~$ </span>" + message + "<br/>";
        affichage.scrollTop = affichage.scrollHeight;
    }
...
// Test si on est dans une page ou pas pour faire le test sans main();
